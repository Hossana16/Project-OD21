...
'<li><span class="fas fa-star fz10 review-color"></span>' +locationPhone+ '</li>'+
'</ul>'+
...
var locations=[
    [locationData('images/resource/listing/1-1.jpg', '5', '7', 'listing-single.html', "I will design modern websites in figma or adobe xd",      '', '4.82 (94 reviews)', 'sky', 'fas fa-star fz10 review-color', 'Hotel', 'Now Closed', ), 40.94401669296697, -74.16938781738281, 1, '<i class="icon flaticon-desk-bell"></i>'],
    [locationData('images/resource/listing/1-2.jpg', '5', '8', 'listing-single.html', "I will do mobile app development for ios and android",  '', '4.82 (94 reviews)', 'pink', 'fas fa-star fz10 review-color', 'Restaurant', 'Now Closed', ), 40.77055783505125, -74.26002502441406, 2, '<i class="icon flaticon-cutlery"></i>'], 
    [locationData('images/resource/listing/1-3.jpg', '5', '9', 'listing-single.html', "I will create modern flat design illustration",'', '4.82 (94 reviews)', 'purple', 'fas fa-star fz10 review-color', 'Art & History', 'Now Closed', ), 40.7427837, -73.11445617675781, 3, '<i class="icon flaticon-tent"></i>'], 
    [locationData('images/resource/listing/2-1.jpg', '5', '6', 'listing-single.html', "I will do mobile app development for ios and android", '', '4.82 (94 reviews)', 'green', 'fas fa-star fz10 review-color', 'Shopping', 'Now Closed', ), 40.70437865245596, -73.98674011230469, 4, '<i class="icon flaticon-shopping-bag"></i>'], 
    [locationData('images/resource/listing/2-2.jpg', '5', '5', 'listing-single.html', "I will create modern flat design illustration",     '', '4.82 (94 reviews)', 'pink', 'fas fa-star fz10 review-color', 'Restaurant', 'Now Closed', ), 40.641311, -73.778139, 5, '<i class="icon flaticon-cutlery"></i>'], 
    [locationData('images/resource/listing/2-3.jpg', '5', '4', 'listing-single.html', "I will do mobile app development for ios and android", '', '4.82 (94 reviews)', 'orange', 'fas fa-star fz10 review-color', 'Restaurant', 'Now Closed', ), 41.080938, -73.535957, 6, '<i class="icon flaticon-cutlery"></i>'], 
    [locationData('images/resource/listing/2-4.jpg', '5', '3', 'listing-single.html', "I will create modern flat design illustration ", '', '4.82 (94 reviews)', 'dark-pink', 'fas fa-star fz10 review-color', ' Gym & Fitness ', 'Now Closed', ), 41.079386, -73.519478, 7, '<i class="icon flaticon-mirror"></i>'], 
];
